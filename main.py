...
""" 
SRY CAM TAM 
By SRY (OFFICIAL_cyber_satyam27)
...
def banner():
    os.system("clear")
    print(Fore.LIGHTGREEN_EX + Style.BRIGHT + "SRY Cam Tam by OFFICIAL_cyber_satyam27" + Style.RESET_ALL)

def unlock():
    os.system("clear")
    print(Fore.RED + Style.BRIGHT + "\n🔓 Unlocking SRY Cam Tam Tool" + Style.RESET_ALL)
    ...
    os.system("xdg-open https://youtube.com/@official_cyber_satyam27?si=KIjUlKKtDObLRGT9")
